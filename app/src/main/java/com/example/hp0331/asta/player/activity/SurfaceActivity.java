...
import com.example.hp0331.asta.player.model.Strings;
import com.example.hp0331.asta.player.util.QosObject;
import com.example.hp0331.asta.player.util.QosThread;
import com.example.hp0331.asta.player.util.Settings;
...
public class SurfaceActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.btn_screen_player) {
            if (useHwCodec) {
        ...
        } else if (i == R.id.btn_mute_player) {
            if (ksyMediaPlayer != null) {
                if (mmute == false) {
